...
static struct acpu_level tbl_PVS0_1700MHz[] __initdata = {
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(8),  1025000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(12),  1037500 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(14), 1075000 },
	...
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(18), 1212500 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS1_1700MHz[] __initdata = {
	...
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(12), 1012500 },
	...
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(16), 1125000 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(17), 1150000 },
...
static struct acpu_level tbl_PVS2_1700MHz[] __initdata = {
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(8),   950000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(12),  975000 },
	...
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(16), 1087500 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(17), 1112500 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(18), 1137500 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS3_1700MHz[] __initdata = {
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(8),   925000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(12),  950000 },
	...
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(16), 1050000 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(17), 1075000 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(18), 1100000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS4_1700MHz[] __initdata = {
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(8),   900000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(12),  925000 },
	...
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(16), 1012500 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(17), 1037500 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(18), 1062500 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS5_1700MHz[] __initdata = {
	...
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(16), 1000000 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(17), 1025000 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(18), 1050000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS6_1700MHz[] __initdata = {
	...
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(16),  987500 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(17), 1012500 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(18), 1037500 },
	{ 0, { 0 } }
};
...
static struct pvs_table pvs_tables[NUM_SPEED_BINS][NUM_PVS] __initdata = {
	...
	[1][1] = { tbl_PVS1_1700MHz, sizeof(tbl_PVS1_1700MHz),     37500 },
	[1][2] = { tbl_PVS2_1700MHz, sizeof(tbl_PVS2_1700MHz),     37500 },
	[1][3] = { tbl_PVS3_1700MHz, sizeof(tbl_PVS3_1700MHz),     37500 },
	[1][4] = { tbl_PVS4_1700MHz, sizeof(tbl_PVS4_1700MHz),     37500 },
	[1][5] = { tbl_PVS5_1700MHz, sizeof(tbl_PVS5_1700MHz),     37500 },
	[1][6] = { tbl_PVS6_1700MHz, sizeof(tbl_PVS6_1700MHz),     37500 },
	...
	[14][0] = { tbl_PVS0_1700MHz, sizeof(tbl_PVS0_1700MHz),    0 },
	[14][1] = { tbl_PVS1_1700MHz, sizeof(tbl_PVS1_1700MHz),    25000 },
	[14][2] = { tbl_PVS2_1700MHz, sizeof(tbl_PVS2_1700MHz),    25000 },
	[14][3] = { tbl_PVS3_1700MHz, sizeof(tbl_PVS3_1700MHz),    25000 },
	[14][4] = { tbl_PVS4_1700MHz, sizeof(tbl_PVS4_1700MHz),    25000 },
	[14][5] = { tbl_PVS5_1700MHz, sizeof(tbl_PVS5_1700MHz),    25000 },
	[14][6] = { tbl_PVS6_1700MHz, sizeof(tbl_PVS6_1700MHz),    25000 },
};
